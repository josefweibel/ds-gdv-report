...
```{r boxplot, fig.asp=.3, out.width=".3\\textwidth", wrapfigure=list("R", 0.3), fig.cap=boxplot_caption}
...
```{r appendix-figure-boxplot, fig.asp=.3}
plot_boxplot()
```
